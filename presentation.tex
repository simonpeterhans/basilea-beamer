...
\lecture			{Lecture Name, Thesis or Project Type}{}% Second pair of {} needed.
\author             {Author}
...
%\solidLinesDisabled % Comment this if you want solid lines instead of dashed ones.

\defaultItemize % Comment this to use the custom icon for itemization.
